                       ...
                       SDL_Color background)
{
    ...
    unicodeval_to_utf8str(ch, utf8, sizeof(utf8));
    surface = sdl2_font_renderStrBG_UTF8(font, (const char *)utf8, foreground,
                                         background);
    return surface;
}
                      ...
                      SDL_Color background)
{
    ...
    SDL_Surface *surface = sdl2_font_renderStrBG_UTF8(font, (const char *)utf8,
...
sdl2_font_textSizeChar(SDL2Font *font, Uint32 ch)
{
    ...
    unicodeval_to_utf8str(ch, utf8, sizeof(utf8));
    rect = sdl2_font_textSizeStr_UTF8(font, (const char *)utf8);
    return rect;
}
