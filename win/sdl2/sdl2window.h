...
struct SDL2Window_Methods {
    ...
    void (*putStr)(struct SDL2Window *win, int attr, const char *str,
            boolean mixed);
    void (*startMenu)(struct SDL2Window *win, unsigned long mbehavior);
    void (*addMenu)(struct SDL2Window *win, const glyph_info *glyph,
    ...
    int  (*selectMenu)(struct SDL2Window *win, int how,
            menu_item ** menu_list);
    void (*printGlyph)(struct SDL2Window *win, coordxy x, coordxy y,
            const glyph_info *glyph, const glyph_info *bkglyph);
    void (*redraw)(struct SDL2Window *win);
    win_request_info *(*ctrlNHWindow)(struct SDL2Window *win, int request,
...
extern Uint32 sdl2_get_key(boolean cmd, coordxy *x, coordxy *y, int *mod);
