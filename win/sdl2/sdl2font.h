...
extern SDL_Surface *sdl2_font_renderStr(SDL2Font *font, const char *text, SDL_Color foreground);
extern SDL_Surface *sdl2_font_renderCharBG(SDL2Font *font, Uint32 ch, SDL_Color foreground, SDL_Color background);
extern SDL_Surface *sdl2_font_renderStrBG(SDL2Font *font, const char *text, SDL_Color foreground, SDL_Color background);

/* Text extent */
extern SDL_Rect sdl2_font_textSizeChar(SDL2Font *font, Uint32 ch);
extern SDL_Rect sdl2_font_textSizeStr(SDL2Font *font, const char *text);
